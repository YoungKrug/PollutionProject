...
#include "SeniorProject/Movement.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SENIORPROJECT_API UClass* Z_Construct_UClass_UMovement_NoRegister();
	SENIORPROJECT_API UClass* Z_Construct_UClass_UMovement();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovement_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UMovement_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMovement_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovement, 3588286156);
	template<> SENIORPROJECT_API UClass* StaticClass<UMovement>()
	{
		return UMovement::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMovement(Z_Construct_UClass_UMovement, &UMovement::StaticClass, TEXT("/Script/SeniorProject"), TEXT("UMovement"), false, nullptr, nullptr, nullptr);
